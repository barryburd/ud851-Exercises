...
public class MainActivity extends AppCompatActivity {
    ...
    static ArrayList<String> mLifecylcleCallbacks = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String toDisplay = "";
        for (int i = mLifecylcleCallbacks.size() - 1; i >= 0; i--) {
            toDisplay += mLifecylcleCallbacks.get(i) + "\n";
        }
        mLifecycleDisplay.setText(toDisplay);

                // TODO (5) Clear mLifecycleCallbacks after iterating through it
        mLifecylcleCallbacks.clear();
    ...
    protected void onStop() {
        ...
        mLifecylcleCallbacks.add(0, ON_STOP);
    ...
    protected void onDestroy() {
        ...
        mLifecylcleCallbacks.add(0, ON_DESTROY);
